...
### What is Nova?
Nova is an intelligent CLI tool that enhances project management and development workflows by integrating with common development platforms like Jira, GitLab, Confluence.
...
GitHub Copilot integration is planned for future releases. Currently, we use Ollama for local LLM capabilities.
