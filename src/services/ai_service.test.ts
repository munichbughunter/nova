...
describe('AIService', () => {
    ...
    beforeEach(() => {
        ...
        stub(globalThis, 'fetch', () => {
            return Promise.resolve(
                new Response(JSON.stringify({ results: [{ text: 'Test response' }] }), {
                    status: 200,
        ...
        stub(
            globalThis,
            'generateObject',
            () => Promise.resolve({ result: 'Test object response' }),
        );
    });
    ...
    describe('constructor', () => {
        ...
        it('should initialize with Azure provider when configured as default', () => {
            ...
            assertEquals(
                Deno.env.get('AZURE_OPENAI_API_ENDPOINT'),
                'https://aicp-prod-sc.openai.azure.com/',
            );
        });
    ...
    describe('getInstance', () => {
        ...
        it('should allow options to be passed during initialization', () => {
            const instance = AIService.getInstance(mockConfig, {
                temperature: 0.5,
                maxTokens: 1000,
            });
    ...
    describe('generateObject', () => {
        it('should generate an object matching the provided schema', async () => {
            ...
            service.generateObject = function <T>(
                _prompt: string,
                _schema: z.ZodType<T>,
