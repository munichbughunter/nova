...
await snapshotTest({
  ...
  async fn() {
    ...
    console.log(
      colors.bold('Created:'),
      `${formatLocaleDate(page.history.createdDate)} by ${page.history.createdBy.displayName}`,
    );
    console.log(
      colors.bold('Last Updated:'),
      `${formatLocaleDate(page.history.lastUpdated)} by ${page.history.lastUpdatedBy.displayName}`,
    );
